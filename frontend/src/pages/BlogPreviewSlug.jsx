...
const BlogPreview = () => {
    ...
    const handleLikeToggle = async () => {
        try {
            ...
            const res = await API.post(`/blog/${blog._id}/like`);
    ...
    const handleDelete = async () => {
        ...
        if (result.isConfirmed) {
            try {
                ...
                // FIXED blog._id
                await API.delete(`/blog/delete-blog/${blog._id}`);
        ...
        <div className="bg-black text-white min-h-screen">
            ...
            <div className="relative h-[75vh] w-full">
                ...
                <img
                    src={
                        blog.cover?.url ||
                        "https://res.cloudinary.com/dtzqjly9a/image/upload/v1777372733/brad-pitt-as-sonny-5120x2880-21920_egylqw.jpg"
                    }
                ...
                {isOwner && (
                    <div className="absolute top-64 right-18 z-20">
                        ...
                        <button
                            ...
                            className="bg-black/60 hover:bg-black p-2 rounded-full backdrop-blur transition"
                        >
            ...
            <div className="max-w-3xl mx-auto px-6 py-16">
                ...
                {/* =========================
                    ENGAGEMENT SECTION
                ========================= */}
                <div className="flex items-center gap-8 mt-16 border-t border-white/10 pt-6">
